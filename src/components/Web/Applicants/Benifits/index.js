  ...
  <div>
      ...
      <div className="benifits-list">
        ...
        <div className="benifit">
          ...
          <p>Placement officer for all international nurses</p>
        </div>
        <div className="benifit">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <p>Housing and Travel Department (24/7 support)</p>
        </div>
        <div className="benifit">
          {" "}
          <svg
          ...
          <p>We offer travel & housing at discounted pricing</p>
        </div>
        <div className="benifit">
          {" "}
          <svg
          ...
          <p>Full healthcare benefits (medical/vision /dental)</p>
        </div>
        <div className="benifit">
          {" "}
          <svg
          ...
          <p>Onboarding officer to ensure boarding staff</p>
        </div>
        <div className="benifit">
          {" "}
          <svg
          ...
          <p>Referral bonus – up to $500 dollars (after just 4 weeks)</p>
        </div>
        ...
        <div className="benifit">
          ...
          <p>Paid license & certifications</p>
        </div>
        <div className="benifit">
          {" "}
          <svg
          ...
          <p>Medical requirements per assignment free of charge</p>
        </div>
        <div className="benifit">
          {" "}
          <svg
          ...
          <p>Dedicated recruiters (24/7 support)</p>
        </div>
        <div className="benifit">
          {" "}
          <svg
          ...
          <p>Great relationships with clients & candidates</p>
        </div>
        <div className="benifit">
          {" "}
          <svg
          ...
          <p>Experienced recruiters in the market</p>
        </div>
        <div className="benifit">
          {" "}
          <svg
          ...
          <p>Team of Healthcare Professionals available 24/7</p>
        </div>
        <div className="benifit">
          {" "}
          <svg
        ...
        <div className="benifit">
          ...
          <p>Jobs available throughout US</p>
        </div>
        <div className="benifit">
          {" "}
          <svg
          ...
          <p>Quick turnaround for international nurses</p>
        </div>
        <div className="benifit">
          {" "}
          <svg
        ...
        <div className="benifit">
          ...
          <p>Travel with your family / pets</p>
        </div>
        <div className="benifit">
          {" "}
          <svg
          ...
          <p>Disaster staffing projects</p>
        </div>
        <div className="benifit">
          {" "}
          <svg
