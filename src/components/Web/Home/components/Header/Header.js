    ...
    <div className="header">
      <Carousel  className="carousel" controls={false} fade>
        <Carousel.Item interval={3000}>
          <Image
            src="https://images.unsplash.com/photo-1529528744093-6f8abeee511d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80"
            fluid
